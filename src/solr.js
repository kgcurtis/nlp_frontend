...
export const doGetSearch = (query) => {
  return new Promise(function(resolve, reject) {
    ...
    let url = 'http://ec2-18-207-71-197.compute-1.amazonaws.com:8983/solr/my_core/select?hl=on&hl.fragsize=0&hl.preserveMulti=true&hl.simple.pre=<span class="highlight">&hl.simple.post=</span>&q=' + encodeURI(query);
