...
export const doGetSearch = (query) => {
  return new Promise(function(resolve, reject) {
    ...
    let url = 'http://ec2-3-80-214-110.compute-1.amazonaws.com:8983/solr/my_core/select?hl=on&hl.fragsize=0&hl.simple.pre=<span class="highlight">&hl.simple.post=</span>&q=' + encodeURI(query);
